                    ...
                    <div data-clipboard-text="{{theme_config('hero.server.ip') ?? 'placeholder'}}" class="copy_ip hero-small-box d-flex align-items-center gap-3 bg-dark bg-opacity-25 p-3" style="cursor : pointer;">
                        <div>
                            ...
                            <div class="position-relative">
                                <p class="ip_address m-0">{{theme_config('hero.server.ip') ?? 'placeholder'}}</p>
                    ...
                    @if(!theme_config('block.discord.toggle'))
                        ...
                        @else
                            <div class="text-center mx-2 mb-2">
                                <iframe height="400" width="100%" src="https://discordapp.com/widget?id={{theme_config('block.discord.id') ?? 'placeholder'}}&theme={{theme_config('block.discord.theme') ?? 'dark'}}"></iframe>
                            </div>
                        @endif
                    @endif
