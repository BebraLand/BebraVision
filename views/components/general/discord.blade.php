<div class="d-flex flex-column rounded-3">
    ...
    <div class="d-flex justify-content-between align-items-end px-4 my-2 py-2">
        <span class="discord-list_count discord-online-count"> {{theme_config('block.discord.textonline') ?? 'Online'}}</span>
        <a class="btn btn-primary" href="{{theme_config('hero.discord.url') ?? 'https://discord.gg/placeholder'}}" target="_blank">{{theme_config('block.discord.textjoin') ?? 'Join'}}</a>
    </div>
</div>
